            ...
            <div class="row">
                <section class="col-md-12">
                    <div >
                        ...
                        <div class="p-2 rounded ">
                            <div class="border rounded d-flex align-items-center mb-4">
                                ...
                                <input type="text" class=" text-center flex-fill" placeholder="신고 제목을 입력하세요" style="font-size: 24px;"/> 
                            </div>
                            <div class="p-2 row">
                                <div class="col-sm-3 text-center border rounded">
                                	신고 날짜 : <input type="date" style="border:none;">
                                </div>
                                <div class="col-sm "></div>
                                <div class="col-sm "></div>
                                <div class="col-sm-3 text-center border rounded">
                                	신고 대상 : 
                                	<input type="text" placeholder="신고 대상 닉네임을 입력" style="border:none;">
                                </div>
                            </div>
                        </div>                
                    </div>
                    <div class="border rounded">
                        	...
                        	min-width: 600px; border:none; width:100%"></textarea>
                    </div>
